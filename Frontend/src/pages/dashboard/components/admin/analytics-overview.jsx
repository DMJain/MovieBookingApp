    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-base-content/60 mt-1">Monitor your platform performance</p>
        </div>
          ...
          <div className="card-body">
            ...
            {monthlyRevenue && monthlyRevenue.length > 0 ? (
              ...
              <div className="flex items-center justify-center h-64">
                <p className="text-base-content/60">No revenue data available</p>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="card-body">
            ...
            {topMovies && topMovies.length > 0 ? (
              ...
              <div className="flex items-center justify-center h-48">
                <p className="text-base-content/60">No movie data available</p>
              </div>
            )}
          </div>
        </div>
      ...
      <div className="card bg-base-200 shadow-xl">
        <div className="card-body">
          ...
          {recentBookings && recentBookings.length > 0 ? (
            ...
            <div className="flex items-center justify-center h-48">
              <p className="text-base-content/60">No recent bookings</p>
            </div>
          )}
        </div>
      </div>
