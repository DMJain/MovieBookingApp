...
const UserDashboard = () => {
  ...
  const BookingCard = ({ booking }) => {
    ...
    return (
      <div className={`card bg-base-100 shadow-xl ${isPast ? 'opacity-75' : ''}`}>
    ...
    <div className="min-h-screen bg-base-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-base-content/70">Manage your bookings and profile</p>
        </div>
            ...
            {upcomingBookings.length === 0 ? (
              <div className="card bg-base-100 shadow-xl">
                <div className="card-body text-center py-12">
                  ...
                  <p className="text-base-content/70 mb-6">You haven't booked any tickets yet. Start exploring movies!</p>
            ...
            {pastBookings.length === 0 ? (
              <div className="card bg-base-100 shadow-xl">
                <div className="card-body text-center py-12">
                  ...
                  <p className="text-base-content/70">Your booking history will appear here</p>
                </div>
              </div>
            ) : (
